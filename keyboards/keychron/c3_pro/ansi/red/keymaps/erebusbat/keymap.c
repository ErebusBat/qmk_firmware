...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_tkl_ansi(
        EB_ESC_HYPR,                KC_F1,       KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   EB_SCRN,  KC_SCRL,  BL_STEP,
    ...
    [MAC_FN] = LAYOUT_tkl_ansi(
        ...
        MO(WIN_BASE), _______,      BL_DOWN,     _______,  _______,  _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  _______,  _______,              _______,
